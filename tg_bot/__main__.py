...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            keyboard = [[InlineKeyboardButton(text="💻 Help",callback_data="help_back"),InlineKeyboardButton(text="🛡Creator",url="https://t.me/Mr_Hops")]]
            keyboard += [[InlineKeyboardButton(text="🌐 Support Group",url="https://t.me/joinchat/JtIgvUuhHJmIzctx6iJvtg"),InlineKeyboardButton(text="⚜️Add Me⚜️",url="t.me/{}?startgroup=true".format(bot.username))]]
